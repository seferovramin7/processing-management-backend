...
public class UserController {
    ...
    public ResponseEntity<?> register(@RequestBody SignUpDto dto) {
        ...
        if (entity == null) {
            ...
            return ResponseEntity.ok(ResponseDto.builder().result(Result.SUCCESS).build());
        } else {
            return new ResponseEntity<>(ResponseDto.builder().result(Result.ALREADY_EXIST).build(),
